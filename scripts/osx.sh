...
defaults write NSGlobalDomain AppleLanguages -array "en" "zh-CN"
...
# Whether display full POSIX path as Finder window title
...
# Wether group windows by application in Mission Control
